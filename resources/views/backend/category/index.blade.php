<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Total Category <span class="px-1 rounded-md bg-indigo-500 text-white">{{ count($category) }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10 bg-white shadow-md text-gray-700">
        <div class="flex justify-between py-8">
            ...
            <div>
                <a href="{{ route('add.category') }}" class="bg-indigo-500 px-3 py-2 rounded-md text-white hover:bg-indigo-600 focus:ring focus:ring-indigo-300 ..."><i class="fa fa-plus"></i></a>
            ...
            <table class="w-full border text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-y border-indigo-500 ...">
                        <td  class="p-3">{{ $category->firstItem()+$loop->index }}</td>
                        ...
                        <td>
                            <a href="{{ url('/edit/category/'.$data->id,$data->slug) }}" class="bg-blue-600 py-1 px-2 text-white rounded-md hover:bg-blue-700 focus:ring focus:ring-blue-300"><i class="fa fa-wrench"></i></a>
                            <a href="{{ url('/delete/category/'.$data->id,$data->slug) }}" class="bg-red-600 py-1 px-2 text-white rounded-md hover:bg-red-700 focus:ring focus:ring-red-300"><i class="fa fa-trash-alt"></i></a>
                        </td>
                    </tr>
                    @endforeach
