<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Total Brand <span class="px-1 rounded-md bg-indigo-500 text-white">{{ count($trashed) }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-10 bg-white shadow-md text-gray-700">
        <div class="flex justify-between py-8">
            ...
            <div>
                <a href="{{ route('all.brands') }}" class="bg-indigo-500 px-3 py-2 rounded-md text-white hover:bg-indigo-600 focus:ring focus:ring-indigo-300 ..."><i class="fa fa-reply"></i></a>
            ...
            <table class="w-full border text-left">
                ...
                <tbody>
                    ...
                    <tr class="border-y border-indigo-500 ...">
                        ...
                        <td>
                            <a href="{{ url('/restore/Brand/'.$data->id,$data->slug) }}" class="bg-blue-600 py-1 px-2 text-white rounded-md hover:bg-blue-700 focus:ring focus:ring-blue-300"><i class="fa fa-undo-alt"></i> Retore</a>
                            <a href="{{ url('/force/delete/brand/'.$data->id) }}" class="bg-red-600 py-1 px-2 text-white rounded-md hover:bg-red-700 focus:ring focus:ring-red-300"><i class="fa fa-trash-alt"></i> Delete</a>
                        </td>
                    </tr>
                    @endforeach
